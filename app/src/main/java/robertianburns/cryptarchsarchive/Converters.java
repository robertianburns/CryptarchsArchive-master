...
/**
 * Converts things needed for the app to work. This is needed for ManifestDefinition.
 *
 * @version 1.0.0
 * @since 1.0.0
 */
public class Converters {
     ...
     * A JSON object consists of name-value pairs where names are strings, and values are any other
     ...
     * encoding. 'toString()' gives the textual String representation (text) of the JSON object,
     * and 'getBytes()' encodes that String into a byte array.
     *
